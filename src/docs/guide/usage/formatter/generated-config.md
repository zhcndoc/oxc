...
类型：`"side_effect" | "type" | "value" | "default" | "wildcard" | "named"`

用于匹配 `customGroups` 中导入特征的修饰符（语义请参阅 `sortImports.groups`）。

##### sortImports.customGroups[n].selector

类型：`"type" | "side_effect_style" | "side_effect" | "style" | "index" | "sibling" | "parent" | "subpath" | "internal" | "builtin" | "external" | "import"`
