...
为了获得更好的失败信息，应该使用 [`toHaveBeenCalledTimes`
而不是直接检查 `mock.calls` 的长度](https://github.com/jest-community/eslint-plugin-jest/blob/v29.5.0/docs/rules/prefer-to-have-been-called-times.md)。
