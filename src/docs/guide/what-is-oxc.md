...
Oxc 是 [VoidZero](https://voidzero.dev) 对 JavaScript 统一、高性能工具链愿景的一部分。它为 [Rolldown](https://rolldown.rs)（[Vite 8 的 bundler](https://vite.dev/blog/announcing-vite8)）提供支持，并推动下一代超快开发工具无缝协作。
